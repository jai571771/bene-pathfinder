...
export const mockSchemes: Scheme[] = [
  ...
  },
  {
    ...
    category: 'Education',
    ministry: 'Tamil Nadu Education Department',
    description: 'Financial assistance for girl students from government schools pursuing higher education in Tamil Nadu.',
    type: 'state',
    state: 'Tamil Nadu',
    gender: 'female',
    maxAge: 25,
    incomeLimit: 300000,
    benefits: '₹1,000/month stipend for college education',
    documents: ['Aadhaar Card', 'School Certificate', 'Community Certificate', 'Bank Details'],
    aiScore: 0.88,
    ruleMatches: { age: true, income: true, location: true, gender: false, category: true },
  },
  {
    ...
    description: 'Free laptops for students who pass 12th standard in government and government-aided schools in Tamil Nadu.',
    type: 'state',
    state: 'Tamil Nadu',
    maxAge: 22,
    benefits: 'Free laptop with pre-loaded educational content',
    documents: ['Aadhaar Card', '12th Marksheet', 'School Bonafide', 'Bank Details'],
    aiScore: 0.91,
    ruleMatches: { age: true, income: true, location: true, gender: true, category: true },
  },
  {
    id: 'SCH-009',
    title: 'Government Exam Fee Reimbursement',
    category: 'Education',
    ministry: 'Tamil Nadu BC/MBC Welfare Department',
    description: 'Reimbursement of competitive examination fees for students from backward classes.',
    type: 'state',
    state: 'Tamil Nadu',
    maxAge: 35,
    incomeLimit: 250000,
    benefits: 'Full reimbursement of exam fees (UPSC, TNPSC, SSC, etc.)',
    documents: ['Aadhaar Card', 'Community Certificate', 'Exam Hall Ticket', 'Fee Receipt'],
    aiScore: 0.76,
    ruleMatches: { age: true, income: true, location: true, gender: true, category: false },
  },
  {
    id: 'SCH-010',
    title: 'Merit Scholarship Tamil Nadu',
    category: 'Education',
    ministry: 'Tamil Nadu Scholarship Department',
    description: 'Merit-based scholarship for top-performing students in Tamil Nadu board exams.',
    type: 'state',
    state: 'Tamil Nadu',
    maxAge: 25,
    incomeLimit: 400000,
    benefits: '₹10,000 - ₹50,000/year based on course',
    documents: ['Marksheet', 'Income Certificate', 'Community Certificate', 'Bank Details'],
    aiScore: 0.93,
    ruleMatches: { age: true, income: true, location: true, gender: true, category: true },
  },
  {
    id: 'SCH-011',
    title: 'Central Post-Matric Scholarship',
    category: 'Education',
    ministry: 'Ministry of Social Justice & Empowerment',
    description: 'Scholarship for SC/ST/OBC students studying at post-matriculation level across India.',
    type: 'central',
    maxAge: 30,
    incomeLimit: 250000,
  ...
  {
    id: 'SCH-012',
    title: 'UGC Rural Student Scholarship',
    category: 'Education',
    ministry: 'University Grants Commission',
    description: 'Scholarship for meritorious students from rural areas pursuing UG/PG courses.',
    type: 'central',
    maxAge: 28,
    incomeLimit: 300000,
    benefits: '₹36,000/year + book allowance',
    documents: ['Aadhaar Card', 'Rural Residence Certificate', 'Marksheet', 'Bank Details'],
    aiScore: 0.79,
    ruleMatches: { age: true, income: true, location: false, gender: true, category: true },
  },
  {
    ...
    category: 'Education',
    ministry: 'Ministry of Education',
    description: 'Scholarship for meritorious students from economically weaker sections to reduce dropouts at class 8.',
    type: 'central',
    maxAge: 18,
    incomeLimit: 350000,
    benefits: '₹12,000/year from Class 9 to 12',
    documents: ['Aadhaar Card', 'Income Certificate', 'Marksheet', 'School Certificate'],
    aiScore: 0.90,
    ruleMatches: { age: true, income: true, location: true, gender: true, category: true },
  },
  {
    ...
    description: 'Financial assistance for girl students who complete their education up to graduation in Tamil Nadu.',
    type: 'state',
    state: 'Tamil Nadu',
    gender: 'female',
    maxAge: 25,
    benefits: '₹25,000 upon completing graduation',
    documents: ['Aadhaar Card', 'Degree Certificate', 'Community Certificate', 'Bank Details'],
    aiScore: 0.86,
    ruleMatches: { age: true, income: true, location: true, gender: false, category: true },
  },
  {
    ...
    description: 'Pre and Post-matric scholarship for students belonging to minority communities.',
    type: 'central',
    maxAge: 30,
    incomeLimit: 200000,
    benefits: 'Up to ₹30,000/year',
    documents: ['Aadhaar Card', 'Minority Community Certificate', 'Income Certificate', 'Marksheet'],
    aiScore: 0.74,
    ruleMatches: { age: true, income: true, location: true, gender: true, category: false },
  },
  {
    id: 'SCH-016',
    title: 'EBC Fee Concession',
    category: 'Education',
    ministry: 'Tamil Nadu Higher Education Department',
    description: 'Fee concession for economically backward class students in Tamil Nadu government colleges.',
    type: 'state',
    state: 'Tamil Nadu',
    incomeLimit: 100000,
    benefits: 'Full tuition fee waiver',
    documents: ['Aadhaar Card', 'EBC Certificate', 'Income Certificate', 'Admission Letter'],
    aiScore: 0.81,
    ruleMatches: { age: true, income: true, location: true, gender: true, category: false },
  },
  {
    id: 'SCH-017',
    title: 'Free Bus Pass for Girls',
    category: 'Education',
    ministry: 'Tamil Nadu Transport Department',
    description: 'Free bus pass for girl students traveling to educational institutions in Tamil Nadu.',
    type: 'state',
    state: 'Tamil Nadu',
    gender: 'female',
    maxAge: 25,
    benefits: 'Free bus travel pass for all state transport buses',
    documents: ['Aadhaar Card', 'Student ID', 'School/College Bonafide', 'Photo'],
    aiScore: 0.94,
    ruleMatches: { age: true, income: true, location: true, gender: false, category: true },
  },
  {
    id: 'SCH-018',
    title: 'State Education Loan Interest Waiver',
    category: 'Education',
    ministry: 'Tamil Nadu Finance Department',
    description: 'Interest waiver on education loans for students from economically weaker sections in Tamil Nadu.',
    type: 'state',
    state: 'Tamil Nadu',
    incomeLimit: 400000,
    benefits: 'Complete interest waiver on education loan up to ₹7.5 lakh',
    documents: ['Aadhaar Card', 'Loan Sanction Letter', 'Income Certificate', 'Admission Letter'],
    aiScore: 0.77,
    ruleMatches: { age: true, income: true, location: true, gender: true, category: true },
  },
];
